  ...
  return (
    <>
      <section className='text-white  flex justify-center items-center xl:py-20 lg:py-15 py-10 '>
        <div className="grid md:grid-cols-2 grid-cols-1  xl:px-20 lg:px-15 md:px-10 px-5 md:gap-5">
          <div className=''>
            ...
            <p className='text-[#8B8B8B] text-md md:text-lg md:text-left text-justify'>At Cinema Factory Academy, we deliver focused, hands-on VFX training built to match the standards of today’s leading global studios. Our programs are designed for artists who want a deep, production-ready understanding of the VFX, Filmmaking, and Virtual Production pipeline.
