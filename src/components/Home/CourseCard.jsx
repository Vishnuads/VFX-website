...
const CourseCard = ({ image, title, desc }) => {
    ...
    return (
        <div>
            <div className="group">
                <div className="w-full h-[350px] group-hover:h-[460px] overflow-hidden transition-all duration-400 ease-in-in-out relative ">
                    ...
                    <div className="absolute bottom-5 left-15 z-5 ">
                        <Link to="/course">
                            <button className='cursor-pointer bg-title group-hover:bg-black group-hover:text-title rounded-3xl px-3 py-1 text-[16px] font-medium flex items-center transition-all duration-400 ease-in-out gap-2'>View Full Course <ArrowUpRightIcon /></button>
                        </Link>
                    </div>
