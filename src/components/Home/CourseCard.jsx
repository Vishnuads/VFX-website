        ...
        <div className='w-full'>
            <div className="group  relative overflow-hidden">
                <div className="w-full h-[380px] group-hover:h-[450px]  transition-all duration-500 ease-in-in-out  ">
                    ...
                    <div className='absolute inset-0 bg-title/70 opacity-0 group-hover:opacity-100 group-hover:backdrop-blur-[2px] z-0 transition-all duration-500 ease-in-out'></div>
                    ...
                    <div className="absolute bottom-4 inset-x-0 z-20 flex justify-center ">
                        <Link to="/course">
                            <button className='cursor-pointer bg-title group-hover:bg-black group-hover:text-title rounded-3xl px-4 py-2 flex items-center transition-all duration-500 ease-in-out gap-2'>View Full Course <ArrowUpRightIcon /></button>
                        </Link>
                    </div>
