...
export const SlideTabs = () => {
  ...
  return (
    <ul
      ...
      className="relative mx-auto flex w-fit rounded-lg border border-title bg-black p-1 dark:border-white dark:bg-neutral-800 my-10">
...
const Cursor = ({ position }) => {
  return (
    <motion.li
      ...
      className="absolute z-0 h-7 rounded-lg bg-title text-black md:h-12" />
  );
}; 