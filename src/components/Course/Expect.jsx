...
import Img1 from '../../assets/images/Expect/1.jpeg'
import Img2 from '../../assets/images/Expect/2.jpeg'
import Img3 from '../../assets/images/Expect/3.jpeg'
import Img4 from '../../assets/images/Expect/4.jpeg'
import Img5 from '../../assets/images/Expect/5.jpeg'
...
const Expect = () => {
    ...
    const data = [
        ...
        { img: Img2, title: "studio experience", sub: "From school to studio", desc: "Simulate the full studio pipeline through collaborative projects and real production challenges. On campus, students also complete a short-term practicum, gaining hands-on experience directly within the industry." },
        { img: Img3, title: "industry insight", sub: "inside the industry", desc: "Weekly Review of student’s work, one-on-one mentorship, periodic script reviews, all given by the instructors with pixel accuracy to ready you for Studio Dailies." },
        { img: Img4, title: "Review", sub: "Real Time Feedback", desc: "If you want a career in visual effects, not only do you need to know how to do shots, you also need to know how to get Jobs. Learn how to create a demo reel, breakdowns, portfolio site, manage your money, set goals, apply for jobs, and learn the dark art of soft studio skills." },
        { img: Img5, title: "Career prep", sub: "Get Studio-ready", desc: "Simulate the full studio pipeline through collaborative projects and real production challenges. On campus, students also complete a short-term practicum, gaining hands-on experience directly within the industry." },
